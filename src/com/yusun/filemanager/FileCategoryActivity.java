...
import com.yusun.filemanager.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import com.yusun.filemanager.FileCategoryHelper.CategoryInfo;
import com.yusun.filemanager.FileCategoryHelper.FileCategory;
import com.yusun.filemanager.FileExplorerTabActivity.IBackPressedListener;
import com.yusun.filemanager.FileViewInteractionHub.Mode;
import com.yusun.filemanager.Util.SDCardInfo;
...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
    ...
    private void setCategorySize(FileCategory fc, long size) {
        ...
        if (txtId == 0 || resId == 0)
            return;
        //yun add
        if (txtId == R.id.category_legend_other)
        	setTextView(txtId, getString(resId) + ":" + Util.convertStorage(size));
        else setTextView(txtId,  Util.convertStorage(size));
        //yun end
    }
